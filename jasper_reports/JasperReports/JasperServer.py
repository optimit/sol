...
class JasperServer:
    ...
    def start(self):
        ...
        #cwd = '/opt/openerp/server/openerp/addons/jasper_reports/java/'
        ...
        print env
        #command = ['java/java', '-Djava.awt.headless=true', 'com.nantic.jasperreports.JasperServer', unicode(str('8090'))]
        command = ['date']
        print command
        process = subprocess.Popen('date', shell=True, env=env, cwd=cwd)
        if self.pidfile:
